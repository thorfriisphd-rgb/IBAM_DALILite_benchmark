...
The goal is to test the hypothesis that C12orf29 is structurally related to RNA ligases.
...
Runtime on a typical workstation is ~1 minute.
...
A preview of the benchmark results is also printed in the terminal when the pipeline finishes.
